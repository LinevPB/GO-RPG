class questslider
{
	...
	{
		return slider_txt.getPosition().y;
	}
	
	function getSliderWidth()
	{
		return slider_txt.getSize().width;
	}
	
	function getDistance()
	{
		return slider_txt.getPosition().y - slider_frame.getPosition().y;
	}
	...
	function onRender()
	{
		if (slider_visible == true && slider_pressed == true) {
			...
			onClickSlide(slider_txt.getPosition().y - offsetY);
